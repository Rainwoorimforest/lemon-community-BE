...
import kr.adapterz.jpa_practice.dto.chat.ChatRoomNoticeRequestDto;
...
import kr.adapterz.jpa_practice.dto.chat.GetChatRoomResponseDto;
...
public class ChatRoomController {
    ...
    public ResponseEntity<ApiResponse<CreateChatRoomResponseDto>> createChatRoom(
        ...
        CreateChatRoomResponseDto result = chatRoomService.createChatRoom(request, userDetails.getUserId());
    ...
    public ResponseEntity<ApiResponse<CreateChatRoomResponseDto>> createChatRoomNotice(
            @PathVariable("chatRoomId") Long roomId,
            @AuthenticationPrincipal CustomUserDetails userDetails,
            @Valid @RequestBody ChatRoomNoticeRequestDto request
    ) {

        CreateChatRoomResponseDto result = chatRoomService.createChatRoomNotice(roomId, request, userDetails);
    ...
    public ResponseEntity<ApiResponse<GetChatRoomResponseDto>> getChatRoom(
            @PathVariable("chatRoomId") Long roomId,
            @AuthenticationPrincipal CustomUserDetails userDetails
    ) {
        GetChatRoomResponseDto result = chatRoomService.getChatRoom(roomId, userDetails);
